...
const ReportBugForm = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    bugData.append("title", formData.title);
    bugData.append("description", formData.description);
    bugData.append("severity", formData.severity);
  ...
  //   try {
  //     setUploading(true);
  //     const res = await axios.post("/uploads/uploaded-bug-video", formData, {
  //       headers: {
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Add relevant tags to help categorize the bug
            </p>
          </div>
